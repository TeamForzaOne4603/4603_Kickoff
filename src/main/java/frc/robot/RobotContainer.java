...
import frc.robot.commands.Pruebas_Intake.IntakeMustang;
...
public class RobotContainer {
  ...
  private final IntakeMustang MustangCmd = new IntakeMustang();
  ...
  private final Command anotarL1 = new Anotar(NewElevatorConstants.kStowHeight);
  ...
  public RobotContainer() {
    ...
    NamedCommands.registerCommand("L2", anotarL2);   
    NamedCommands.registerCommand("L1", anotarL1);
    NamedCommands.registerCommand("L4", anotarL4);
  ...
  //  joy_op.rightTrigger().whileTrue(Climber.getInstance().Spool(0.7));
    ...
    joy_Prueba.b().onTrue(NewElevator.getInstance().goToPosition(NewElevatorConstants.kL3Height));
    joy_Prueba.y().onTrue(NewElevator.getInstance().goToPosition(NewElevatorConstants.kL4Height));
    joy_Prueba.a().onTrue(NewElevator.getInstance().goToPosition(NewElevatorConstants.kStowHeight));
    joy_Prueba.x().onTrue(NewElevator.getInstance().goToPosition(NewElevatorConstants.kL2Height));

    joy_Prueba.leftBumper().onTrue(IntakeCmd);
    joy_Prueba.rightBumper().onTrue(MustangCmd);

    joy_Prueba.povUp().whileTrue(NewElevator.getInstance().manualMove(0.3));
    joy_Prueba.povDown().whileTrue(NewElevator.getInstance().manualMove(-0.3));
    joy_Prueba.rightTrigger().whileTrue(CoralShooter.getInstance().shootPosition());
    joy_Prueba.leftTrigger().whileTrue(CoralShooter.getInstance().Commandspeed(0.3));
    joy_Prueba.leftStick().whileTrue(CoralShooter.getInstance().Commandspeed(-0.15));
